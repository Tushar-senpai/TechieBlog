...
const FAQ = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          {faqItems.map((item, index) => (
            <motion.div
              ...
              className={`flex ${item.type === 'question' ? 'justify-start' : 'justify-end'} items-start gap-4`}
            >
              {item.type === 'question' && (
                <>
                  ...
                  <div className="flex-1 max-w-2xl">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl rounded-tl-none shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              {item.type === 'answer' && (
                <>
                  <div className="flex-1 max-w-2xl">
                    <div className="bg-amber-50 dark:bg-amber-900/30 p-6 rounded-2xl rounded-tr-none shadow-sm border border-amber-100 dark:border-amber-800">
