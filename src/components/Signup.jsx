        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit(create)} className="space-y-4">
              ...
              <motion.div whileFocus={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
                <label className="text-sm mb-2 block text-orange-500 font-bold">Email</label>
                <Input
                  name="email"
                  type="email"
                  required
              ...
              <motion.div whileFocus={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
                <label className="text-sm mb-2 block text-orange-500 font-bold">Password</label>
              ...
              <motion.div whileFocus={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
                <label className="text-sm mb-2 block text-orange-500 font-bold">Confirm Password</label>
                <Input
              ...
              <div className="flex items-center">
                <input
                  ...
                  required
                />
                <label htmlFor="remember-me" className="ml-3 block text-sm text-orange-500">
                  I accept the{" "}
                  <Link to="/terms" className="text-blue-600 font-semibold hover:underline ml-1">
