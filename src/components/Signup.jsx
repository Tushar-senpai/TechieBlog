          ...
          >
            ...
            <form onSubmit={handleSubmit(create)} className="space-y-4">
              ...
              <motion.div whileFocus={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
                ...
                <Input name="confirmPassword" type="password" required {...register("confirmPassword", { required: true })} className="w-full text-sm text-gray-800 border border-gray-300 p-3 rounded-lg outline-orange-600" placeholder="Re-enter password" />
