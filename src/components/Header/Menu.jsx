    ...
    <div className="relative ml-3 md:ml-0 animate-fade-in">
      ...
      {isMenuOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-gradient-to-r from-yellow-100 via-orange-100 to-red-100 dark:bg-gradient-to-r dark:from-gray-800 dark:via-gray-900 dark:to-black border border-orange-200 dark:border-gray-700 rounded-xl shadow-lg transition duration-300 animate-slide-down z-50">
          <div className="py-2">
            <p className="font-semibold text-gray-800 dark:text-gray-100 mb-0 px-4 transition duration-300">{username}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-0 px-4 transition duration-300">Welcome back!</p>
          </div>
          <div className="border-t border-orange-200 dark:border-gray-700 transition duration-300"></div>
          <div>
            <Link to="/profile">
              <div className="flex items-center px-4 py-2 text-gray-800 dark:text-gray-200 hover:bg-orange-200/50 dark:hover:bg-gray-800 transition duration-300 cursor-pointer" onClick={toggleMenu}>
